    ...
    <div className="row">
        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 py-3">
            <div className="card h-100">
                <img src="./public/leadership-img.png" className="card-img-top" alt="" />
        ...
        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 py-3">
            <div className="card h-100">
                <img src="./public/CareerDevelopment-img.jpg" className="card-img-top" alt="" />
                <div className="card-body">
                ...
                <p className="card-text">Work out what motivates you to go to work in the morning.
                    ...
                    How to get started with self-employment.</p>
                <a href="#" className="know-more-link">Know More</a>
                </div>
            </div>
        </div>
        ...
        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 py-3">
            <div className="card h-100">
                <img src="./public/PersonalDevelopment-img.jpg" className="card-img-top" alt="" />
                <div className="card-body">
                ...
                <p className="card-text">Develop a stronger ability to cope with adversity and bounce back from challenges, improving your overall mental health and well-being.
                    Acquire a positive, growth-oriented mindset, helping you approach life and work with greater confidence and optimism.</p>
                <a href="#" className="know-more-link">Know More</a>
                </div>
            </div>
        </div>
        ...
        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3 py-3">
            <div className="card h-100">
                <img src="./public/AngerManagement-img.png" className="card-img-top" alt="" />
                <div className="card-body">
